...
describe('bookshelf-jsonapi-params', () => {
  ...
  describe('passing a `filters` parameter with a single filter', () => {
    ...
    it('should return a single record with the matching id |DeliverMD filter style', (done) => {
      PersonModel
        .forge()
        .fetchJsonApi({
          filter: {
    ...
    it('should return a single record with the matching type as null| DeliverMD filter style', (done) => {
      PersonModel
        .forge()
        .fetchJsonApi({
          filter: {
  ...
  describe('passing a `filter[ne]` parameter with a single filter', () => {
    it('should return all records that do not match filter[ne]', (done) => {
      PersonModel
        .forge()
        .fetchJsonApi({
          filter: {
    ...
    it('should return all records that do not match filter[not]', (done) => {
      PersonModel
        ...
        .fetchJsonApi({
          filter: {
            first_name: {
              notin: ['Barney', 'Baby Bop', 'Boo', 'Elmo'],
            }
          }
        })
        .then((result) => {
  ...
  describe('passing a `filter[lt] and filter[gt]` parameter', () => {
    it('should return all records that are less than filter[lt]', (done) => {
      PersonModel
        .forge()
        .fetchJsonApi({
  ...
  describe('passing a `search` parameter for relationships', () => {
    it('should return all records that have a pet with name', (done) => {
      PersonModel
        .forge()
        .fetchJsonApi({
